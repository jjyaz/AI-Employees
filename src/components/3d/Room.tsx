...
export function Room() {
  ...
  useFrame(({ clock }) => {
    ...
    if (ledRef.current) {
      ledRef.current.intensity = 0.5 + Math.sin(t * 0.5) * 0.2;
    }
    if (ledRef2.current) {
      ledRef2.current.intensity = 0.4 + Math.sin(t * 0.7 + 1) * 0.2;
    }
  });
  ...
  return (
    <group>
      ...
      <group position={[5.49, 3.5, 0]} rotation={[0, -Math.PI / 2, 0]}>
        ...
        <pointLight position={[0, 0, 0.5]} color="#8899cc" intensity={1.5} distance={8} decay={2} />
      </group>
      ...
      <pointLight ref={ledRef} position={[-5, 5.8, -5]} color="#3b82f6" intensity={0.5} distance={8} />
      <pointLight ref={ledRef2} position={[5, 5.8, 5]} color="#8b5cf6" intensity={0.4} distance={8} />
      <pointLight position={[-5, 5.8, 5]} color="#06b6d4" intensity={0.3} distance={8} />
      <pointLight position={[5, 5.8, -5]} color="#3b82f6" intensity={0.3} distance={8} />
